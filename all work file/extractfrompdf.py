...
#os.chdir('D:\\BSD SCRIPTS\\Windows Server 2016\\all work file') # asta-i obtional, uneori VSCODE ruleaza din alta parte 
cisFile = open("CIS2016.txt",  encoding="utf8") # fisierul necesar de prelucrat
