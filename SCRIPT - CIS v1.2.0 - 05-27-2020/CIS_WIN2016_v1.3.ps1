...
{
    $stat = 'Fail'
    Write-Host "1.1.1 (L1) Ensure 'Enforce password history' is set to '24 or more password(s)' (Scored)"
...
{
    $stat = 'Fail'
    Write-Host "1.1.2 (L1) Ensure 'Maximum password age' is set to '60 or fewer days, but not 0' (Scored)"
	if ((Get-WmiObject -Class Win32_ComputerSystem).PartOfDomain){
...
{
    $stat = 'Fail'
    Write-Host "1.1.3 (L1) Ensure 'Minimum password age' is set to '1 or more day(s)' (Scored)"
	if ((Get-WmiObject -Class Win32_ComputerSystem).PartOfDomain){
...
{
    $stat = 'Fail'
    Write-Host "1.1.4 (L1) Ensure 'Minimum password length' is set to '14 or more character(s)' (Scored)"
	if ((Get-WmiObject -Class Win32_ComputerSystem).PartOfDomain){
...
{
    $stat = 'Fail'
    Write-Host "1.1.5 (L1) Ensure 'Password must meet complexity requirements' is set to 'Enabled' (Scored)"
...
{
    $stat = 'Fail'
    Write-Host "1.1.6 (L1) Ensure 'Store passwords using reversible encryption' is set to 'Disabled' (Scored)"
...
{
    $stat = 'Fail'
    Write-Host "1.2.1 (L1) Ensure 'Account lockout duration' is set to '15 or more minute(s)' (Scored)"
	if ((Get-WmiObject -Class Win32_ComputerSystem).PartOfDomain){
...
{
    $stat = 'Fail'
    Write-Host "1.2.2 (L1) Ensure 'Account lockout threshold' is set to '10 or fewer invalid logon attempt(s), but not 0' (Scored)"
	if ((Get-WmiObject -Class Win32_ComputerSystem).PartOfDomain){
...
{
    $stat = 'Fail'
    Write-Host "1.2.3 (L1) Ensure 'Reset account lockout counter after' is set to '15 or more minute(s)' (Scored)"
	if ((Get-WmiObject -Class Win32_ComputerSystem).PartOfDomain){
...
{
    $stat = 'Fail'
    Write-Host "2.2.1 (L1) Ensure 'Access Credential Manager as a trusted caller' is set to 'No One' (Scored)"
...
{
    $stat = 'Fail'
    Write-Host "2.2.2 (L1) Ensure 'Access this computer from the network' is set to 'Administrators, Authenticated Users, ENTERPRISE DOMAIN CONTROLLERS' (DC only) (Scored)"
...
{
    $stat = 'Fail'
    Write-Host "2.2.4 (L1) Ensure 'Act as part of the operating system' is set to 'No One' (Scored)"
...
{
    $stat = 'Fail'
    Write-Host "2.2.5 (L1) Ensure 'Add workstations to domain' is set to 'Administrators' (DC only) (Scored)"
...
{
    $stat = 'Fail'
    Write-Host "2.2.8 (L1) Ensure 'Allow log on through Remote Desktop Services' is set to 'Administrators' (DC only) (Scored)"
...
{
    $stat = 'Fail'
    Write-Host "2.2.17 (L1) Ensure 'Create symbolic links' is set to 'Administrators' (DC only) (Scored)"
...
{
    $stat = 'Fail'
    Write-Host "2.2.20 (L1) Ensure 'Deny access to this computer from the network' to include 'Guests' (DC only) (Scored)"
...
{
    $stat = 'Fail'
    Write-Host "2.2.25 (L1) Ensure 'Deny log on through Remote Desktop Services' to include 'Guests' (DC only) (Scored)"
...
{
    $stat = 'Fail'
    Write-Host "2.2.27 (L1) Ensure 'Enable computer and user accounts to be trusted for delegation' is set to 'Administrators' (DC only) (Scored)"
...
{
    $stat = 'Fail'
    Write-Host "2.2.30 (L1) Ensure 'Generate security audits' is set to 'LOCAL SERVICE, NETWORK SERVICE' (Scored)"
...
{
    $stat = 'Fail'
    Write-Host "2.2.31 (L1) Ensure 'Impersonate a client after authentication' is set to 'Administrators, LOCAL SERVICE, NETWORK SERVICE, SERVICE' (DC only) (Scored)"
...
{
    $stat = 'Fail'
    Write-Host "2.2.32 (L1) Ensure 'Impersonate a client after authentication' is set to 'Administrators, LOCAL SERVICE, NETWORK SERVICE, SERVICE' and (when the Web Server (IIS) Role with Web Services Role Service is installed) 'IIS_IUSRS' (MS only) (Scored)"
...
{
    $stat = 'Fail'
    Write-Host "2.2.33 (L1) Ensure 'Increase scheduling priority' is set to 'Administrators' (Scored)"
...
{
    $stat = 'Fail'
    Write-Host "2.2.36 (L2) Ensure 'Log on as a batch job' is set to 'Administrators' (DC Only) (Scored)"
...
{
    $stat = 'Fail'
    Write-Host "2.2.37 (L1) Ensure 'Manage auditing and security log' is set to 'Administrators' and (when Exchange is running in the environment) 'Exchange Servers' (DC only) (Scored)"
...
{
    $stat = 'Fail'
    Write-Host "2.2.47 (L1) Ensure 'Synchronize directory service data' is set to 'No One' (DC only) (Scored)"
...
{
    $stat = 'Fail'
    Write-Host "2.3.5.1 (L1) Ensure 'Domain controller: Allow server operators to schedule tasks' is set to 'Disabled' (DC only) (Scored)"
...
{
    $stat = 'Fail'
    Write-Host "2.3.5.2 (L1) Ensure 'Domain controller: LDAP server signing requirements' is set to 'Require signing' (DC only) (Scored)"
...
{
    $stat = 'Fail'
    Write-Host "2.3.5.3 (L1) Ensure 'Domain controller: Refuse machine account password changes' is set to 'Disabled' (DC only) (Scored)"
...
function _2.3.7.1.DontDisplayLastSigned{
    $stat = 'Fail'
    Write-Host "2.3.7.1 (L1) Ensure 'Interactive logon: Do not display last user name' is set to 'Enabled' (Scored)"
...
function _2.3.7.2.RequireCtlAltDel{
    $stat = 'Fail'
    Write-Host "2.3.7.2 (L1) Ensure 'Interactive logon: Do not require CTRL+ALT+DEL' is set to 'Disabled' (Scored)"
...
function _2.3.10.6.NullSessionPipesDC{
    $stat = 'Fail'
    Write-Host "2.3.10.6 (L1) Configure 'Network access: Named Pipes that can be accessed anonymously' (DC only) (Scored)"
...
function _2.3.11.5.NoLMHash{
    $stat = 'Fail'
    Write-Host "2.3.11.5 Ensure 'Network security: Do not store LAN Manager hash value on next password change' is set to 'Enabled'"
...
function _2.3.11.6.ForceLogoff{
    $stat = 'Fail'
    Write-Host "2.3.11.6 Ensure 'Network security: Force logoff when logon hours expire' is set to 'Enabled'"
...
function _2.3.11.7.LmCompatibilityLevel{
    $stat = 'Fail'
    Write-Host "2.3.11.7 Ensure 'Network security: LAN Manager authentication level' is set to 'Send NTLMv2 response only. Refuse LM & NTLM'"
...
function _2.3.11.8.LDAPClientIntegrity{
    $stat = 'Fail'
    Write-Host "2.3.11.8 Ensure 'Network security: LDAP client signing requirements' is set to 'Negotiate signing' or higher"
...
function _17.1.2.KerberosAuthenticationService{
    $stat = 'Fail'
    Write-Host "17.1.2 (L1) Ensure 'Audit Kerberos Authentication Service' is set to 'Success and Failure' (DC Only) (Scored)"
...
function _17.1.3.KerberosServiceTicketOperations{
    $stat = 'Fail'
    Write-Host "17.1.3 (L1) Ensure 'Audit Kerberos Service Ticket Operations' is set to 'Success and Failure' (DC Only)"
...
function _17.2.2.AuditComputerAccountManagementDC{
    $stat = 'Fail'
    Write-Host "17.2.2 (L1) Ensure 'Audit Computer Account Management' is set to include 'Success' (DC only) (Scored)"
...
function _17.2.3.AuditDistribGroupManagementDC{
    $stat = 'Fail'
    Write-Host "17.2.3 (L1) Ensure 'Audit Distribution Group Management' is set to include 'Success' (DC only) (Scored)"
...
function _17.2.4.AuditOtherAccountManagementEventsDC{
    $stat = 'Fail'
    Write-Host "17.2.4 (L1) Ensure 'Audit Other Account Management Events' is set to include 'Success' (DC only) (Scored)"
...
function _17.4.1.AuditDirectoryServiceAccessDC{
    $stat = 'Fail'
    Write-Host "17.4.1 (L1) Ensure 'Audit Directory Service Access' is set to include 'Failure' (DC only) (Scored)"
...
function _17.4.2.AuditDirectoryServiceChangesDC{
    $stat = 'Fail'
    Write-Host "17.4.2 (L1) Ensure 'Audit Directory Service Changes' is set to include 'Success' (DC only) (Scored)"
...
function _17.5.2.AuditGroupMembership{
    ...
    try { $val = Auditpol /get /subcategory:$sub_c | Select-String -SimpleMatch $sub_c  }catch { $val = "An error occurred. Disabled or Not Configured" }
    #$val = Auditpol /get /subcategory:$sub_c | Select-String -SimpleMatch $sub_c 
    Write-Host "Command:  Auditpol /get /subcategory:$sub_c | Select-String -SimpleMatch $sub_c"
    Write-Host "Command result: "$val
    $val  -match '\s\s\s.+\w*$' | Out-Null
...
function _18.2.1_18.2.6.LAPS{
    $stat = 'Pass'
    Write-Host "18.2.1 (L1) Ensure LAPS AdmPwd GPO Extension / CSE is installed (MS only) (Scored)"
...
function _18.2.2.PwdExpirationProtectionEnabled{
    $stat = 'Fail'
    Write-Host "18.2.2 (L1) Ensure 'Do not allow password expiration time longer than required by policy' is set to 'Enabled' (MS only) "
...
function _18.2.3.AdmPwdEnabled{
    $stat = 'Fail'
    Write-Host "8.2.3 (L1) Ensure 'Enable Local Admin Password Management' is set to 'Enabled' (MS only)"
    $reg_p = "HKLM:\SOFTWARE\Policies\Microsoft Services\AdmPwd"
    $reg_n = "AdmPwdEnabled"
    try{ $val = Get-ItemPropertyValue $reg_p -Name $reg_n -ErrorAction SilentlyContinue}catch{$val = ""}
    Write-Host "Command:  Get-ItemPropertyValue $reg_p -Name $reg_n"
...
function _18.2.4.PasswordComplexity{
    $stat = 'Fail'
    Write-Host "18.2.4 (L1) Ensure 'Password Settings: Password Complexity' is set to 'Enabled: Large letters + small letters + numbers + special characters' (MS only)"
    $reg_p = "HKLM:\SOFTWARE\Policies\Microsoft Services\AdmPwd"
...
function _18.2.5.PasswordLength{
    $stat = 'Fail'
    Write-Host "18.2.5 (L1) Ensure 'Password Settings: Password Length' is set to 'Enabled: 15 or more' (MS only)"
    $reg_p = "HKLM:\SOFTWARE\Policies\Microsoft Services\AdmPwd"
...
function _18.2.6.PasswordAgeDays{
    $stat = 'Fail'
    Write-Host "18.2.6 (L1) Ensure 'Password Settings: Password Age (Days)' is set to 'Enabled: 30 or fewer' (MS only)"
    $reg_p = "HKLM:\SOFTWARE\Policies\Microsoft Services\AdmPwd"
...
function _18.3.5.LdapEnforceChannelBindingDC{
    $stat = 'Fail'
    Write-Host "18.3.5 (L1) Ensure 'Extended Protection for LDAP Authentication (Domain Controllers only)' is set to 'Enabled: Enabled, always (recommended)' (DC Only)"
...
function _18.3.6.NetBIOSNodeType{
    $stat = 'Fail'
    Write-Host "18.3.6 (L1) Ensure 'NetBT NodeType configuration' is set to 'Enabled: Pnode (recommended)'"
...
function _18.5.21.1.fMinimizeConnections{
    $stat = 'Fail'
    Write-Host "18.5.21.1 (L1) Ensure 'Minimize the number of simultaneous connections to the Internet or a Windows Domain' is set to 'Enabled: 1 = Minimize simultaneous connections'"
...
function _18.8.5.6.LsaCfgFlagDC{
    $stat = 'Fail'
    Write-Host "18.8.5.6 (NG) Ensure 'Turn On Virtualization Based Security: Credential Guard Configuration' is set to 'Disabled' (DC Only)"
    $reg_p = "HKLM:\SOFTWARE\Policies\Microsoft\Windows\DeviceGuard"
    $reg_n = "LsaCfgFlags"
    try{ $val = Get-ItemPropertyValue $reg_p -Name $reg_n -ErrorAction SilentlyContinue}catch{$val = ""}
    Write-Host "Command:  Get-ItemPropertyValue $reg_p -Name $reg_n"
...
function _18.8.47.5.1.DisableQueryRemoteServer{
    $stat = 'Fail'
    Write-Host "18.8.47.5.1 (L2) Ensure 'Microsoft Support Diagnostic Tool: Turn on MSDT interactive communication with support provider' is set to 'Disabled'"
...
function _18.8.47.11.1.ScenarioExecutionEnabled{
    $stat = 'Fail'
    Write-Host "18.8.47.11.1 (L2) Ensure 'Enable/Disable PerfTrack' is set to 'Disabled'"
...
function _18.8.49.1.DisabledAdvertisingInfo{
    $stat = 'Fail'
    Write-Host "18.8.49.1 (L2) Ensure 'Turn off the advertising ID' is set to 'Enabled'"
...
function _18.8.52.1.1.NtpClientEnabled{
    $stat = 'Fail'
    Write-Host "18.8.52.1.1 (L2) Ensure 'Enable Windows NTP Client' is set to 'Enabled'"
...
function _18.8.52.1.2.DisableWindowsNTPServer{
    $stat = 'Fail'
    Write-Host "18.8.52.1.2 (L2) Ensure 'Enable Windows NTP Server' is set to 'Disabled'"
...
function _18.9.4.1.AllowSharedLocalAppData{
    $stat = 'Fail'
...
function _18.9.39.1.LocationAndSensorsDisableLocation{
    $stat = 'Fail'
    Write-Host "18.9.39.1 (L2) Ensure 'Turn off location' is set to 'Enabled'"
...
function _18.9.86.1.DisableAutomaticRestartSignOn{
    $stat = 'Fail'
    Write-Host "18.9.86.1 (L1) Ensure 'Sign-in and lock last interactive user automatically after a restart' is set to 'Disabled'"
    $reg_p = "HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\Policies\System"
...
function _19.1.3.1.ScreenSaveActive{
    $stat = 'Fail'
    Write-Host "19.1.3.1 (L1) Ensure 'Enable screen saver' is set to 'Enabled' (Scored)"
...
function universalcheck{
    ...
    If($osInfo.ProductType -eq 2){
        $domainGroup = get-adgroup -filter * | sort name | select Name
       
        foreach($group in $domainGroup)
        {
    ...
    Get-Software | Select DisplayName, Version, InstallDate
...
function Level_1_Domain_Controller{
   ...
   _17.1.2.KerberosAuthenticationService
   _17.1.3.KerberosServiceTicketOperations
...
function Level_1_Domain_Controller_Level_1_Member_Server{
    ...
    _2.3.7.1.DontDisplayLastSigned
    _2.3.7.2.RequireCtlAltDel
...
function Level_2_Member_Server{
    ...
    _18.8.52.1.2.DisableWindowsNTPServer
}
...
function Level_2_Domain_Controller_Level_2_Member_Server{
    ...
    _18.8.47.5.1.DisableQueryRemoteServer
    _18.8.47.11.1.ScenarioExecutionEnabled
    _18.8.49.1.DisabledAdvertisingInfo
    _18.8.52.1.1.NtpClientEnabled
    _18.9.4.1.AllowSharedLocalAppData
    _18.9.12.1.DisallowCamera
    _18.9.16.2.DisableEnterpriseAuthProxy
    _18.9.39.1.LocationAndSensorsDisableLocation
