...
wb = openpyxl.load_workbook(os.getcwd() + '\\bin\\CIS_2016(WorkFile).xlsx')
sheet = wb['WS2016']
if sheet:
...
# Deschidem fisierul CIS MWS 2016
cisWS_file = open(os.getcwd() + "\\bin\\CIS_Microsoft_Windows_Server_2016_RTM_Release_1607_Benchmark_v1.2.0.txt",  encoding="utf8") # fisierul necesar de prelucrat
if cisWS_file:
    print("(+) CIS_Microsoft_Windows_Server_2016 file was loaded.")
else:
    print("(-) Can't load 'CIS_Microsoft_Windows_Server_2016' file.")
    quit()
